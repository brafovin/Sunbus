...
export const ALL_PLAYERS: PlayerCard[] = [
  ...
  /* ══════════════════════════════════════════════
     🇸🇾 SYRIEN
  ══════════════════════════════════════════════ */
  { id:'p221s',name:'Mohammed Al-Salkhadi',team:'Syrien NT',       teamEmoji:'🇸🇾', position:'ST', rating:83, pace:80, shooting:84, passing:70, defending:28, rarity:'rare',   price:5000,  image:'⭐' },
